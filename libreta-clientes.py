...
def nuevo_cliente():
    ...
    btnSave = Button(top, text='Guardar', command=guardar)
...
def eliminar_cliente():
    ...
    respuesta = messagebox.askokcancel(
        'Seguro?', 'Estas seguro de querer eliminar el cliente ' + cliente[1] + '?')
...
btnDelete = Button(root, text='Eliminar Cliente', command=eliminar_cliente)
